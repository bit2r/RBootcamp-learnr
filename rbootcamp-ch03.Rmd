...
```{r ch03-pipe, echo = TRUE, eval = FALSE}
...
```{r exc-03-13, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r exc-03-14, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r biopics-count, eval = FALSE, echo=TRUE}
biopics %>% group_by(type_of_subject) %>% summarize(count=n())
```

```{r exc-03-15, exercise=TRUE, exercise.blanks = "___+"}
question("위 코드는 무슨 작업을 수행할까요? 콘솔에서 실행해 보세요!",
...
```{r ch03-arrange, eval = FALSE, echo = TRUE}
...
```{r exc-03-16, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r biopics-ch03-select, eval = FALSE, echo = TRUE}
...
```{r exc-03-17, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r exc-03-18, exercise=TRUE, exercise.blanks = "___+"}
...
```{r exc-03-19, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r exc-03-20, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
biopics <- readRDS("data/biopics.rds")
...
```{r exc-03-21, exercise=TRUE, exercise.blanks = "___+"}
library(dplyr)
library(ggplot2)
biopics <- readRDS("data/biopics.rds")
